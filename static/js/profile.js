 ...
 * Wrapped in an IIFE to ensure complete scope isolation.
 */
(() => {
    ...
    // Expose functions called by HTML event listeners
    window.openProfileModal = openProfileModal;
    window.closeProfileModal = closeProfileModal;
    window.onProfileOverlayClick = onProfileOverlayClick;
    window.switchMemoryScope = switchMemoryScope;
    window.toggleMasterMemory = toggleMasterMemory;
    window.submitNewMemory = submitNewMemory;
    window.onToggleMemoryItem = onToggleMemoryItem;
    window.onDeleteMemoryItem = onDeleteMemoryItem;
